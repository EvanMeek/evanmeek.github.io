...
** 异步与错误
   ...
   #+end_src
* 浏览器中的JavaScript
  前面都是JS的基础语法，JS可以作为前端 => 浏览器，后端 => nodejs使用。
** window对象
   #+begin_src javascript
     console.log("显示区域高度" + window.innerHeight)
     console.log("显示区域宽度" + window.innerWidth)
     ...
     console.log(screen.width)                     // 分辨率-宽
     console.log(screen.height)                    // 分辨率-高

     console.log(location.protocol)                // 协议
     console.log(location.host)                    // 主机
     console.log(location.port)                    // 端口号
     console.log(location.href)                    // 当前地址
     console.log(location.pathname)                // 当前目录
     console.log(location.search)                  // 参数
     console.log(location.reload())                // 刷新当前页面
     console.log(location.assign("www.baidu.com")) // 跳转至指定URL
     console.log(location.href = "www.baidu.com")  // 跳转至指定URL

     console.log(document.referrer)                // 上次访问的地址

     console.log(history.back())                   // 回退页面
     console.log(history.forward())                // 前进页面
     ...
     /*
       ...
       3. 新窗口大小和显示位置
     ,*/
     window.open(url, name, 'width=100,height=100,top=0,left=0')
   #+end_src
